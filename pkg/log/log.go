...
func init() {
	issuerLogFile, err := os.OpenFile("address_issuer.log", os.O_CREATE|os.O_APPEND|os.O_RDWR, 0666)
	if err != nil {
		log.Printf("Failed to create address_issuer log file: %s", err.Error())
	}
