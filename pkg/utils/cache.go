...
func (bc *BigCache) UpdateStruct(key string, entry models.AddressCredentialRequest) error {
	bs, err := json.Marshal(&entry)
	if err != nil {
...
func (bc *BigCache) ReadStruct(key string) (models.AddressCredentialRequest, error) {
